...
class PersonInfo(object):
    ...
    def __init__(self, joints, scores):
    ...
    def pred_flow(self, img, flow_net, device):
        ...
        with torch.no_grad():
            ...
            for scale in TESTCONFIG.flow_scales: # better for metric
                ...
                scale_value = float(scale.split('_')[-1])  #scale_value = 2.0
